  ...
  tokens: {
    ...
    comp: {
      ...
      table: {
        border: 'var(--zaytoon-color-border)',
        radius: 'var(--zaytoon-radius-md)',
        headerBackground: 'var(--zaytoon-color-muted)',
        headerForeground: 'var(--zaytoon-color-foreground)',
        rowBackground: 'var(--zaytoon-color-background)',
        rowBackgroundStriped: 'var(--zaytoon-color-muted)',
        rowBackgroundHover: 'var(--zaytoon-color-muted)',
        rowBackgroundSelected: 'color-mix(in srgb, var(--zaytoon-color-primary) 12%, transparent)',
        fontSize: 'var(--zaytoon-typography-font-size-sm)',
        cellPaddingX: 'var(--zaytoon-spacing-md)',
        cellPaddingY: 'var(--zaytoon-spacing-sm)',
        sortIconColor: 'var(--zaytoon-color-muted-foreground)',
        sortIconColorActive: 'var(--zaytoon-color-foreground)',
      },
      colorPicker: {
        svAreaSize: '12rem',
