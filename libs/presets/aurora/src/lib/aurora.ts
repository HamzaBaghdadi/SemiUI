  ...
  tokens: {
    ...
    comp: {
      ...
      toast: {
        ...
        variants: {
          default: {
            background: 'color-mix(in srgb, var(--semiui-color-background) 88%, transparent)',
            foreground: 'var(--semiui-color-foreground)',
            border: 'var(--semiui-color-border)',
            iconColor: 'var(--semiui-color-muted-foreground)',
          },
          success: {
            background: 'color-mix(in srgb, #22c55e 14%, color-mix(in srgb, var(--semiui-color-background) 88%, transparent))',
            foreground: 'var(--semiui-color-foreground)',
            border: '#22c55e',
            iconColor: '#22c55e',
          },
          ...
          warning: {
            background: 'color-mix(in srgb, #f59e0b 14%, color-mix(in srgb, var(--semiui-color-background) 88%, transparent))',
            foreground: 'var(--semiui-color-foreground)',
            border: '#f59e0b',
            iconColor: '#f59e0b',
          },
          info: {
            background: 'color-mix(in srgb, #3b82f6 14%, color-mix(in srgb, var(--semiui-color-background) 88%, transparent))',
            foreground: 'var(--semiui-color-foreground)',
            border: '#3b82f6',
            iconColor: '#3b82f6',
          },
