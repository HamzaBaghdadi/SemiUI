...
export class AutoCompleteComponent<TOption = unknown> extends BaseFormFieldControl<string> {
  ...
  /** Closes the panel when a scroll container under the input scrolls, instead of repositioning
   ...
   * so every click inside it (a suggestion) would read as an outside click and close the
